This is my first game that I coded in Python. It is similr to Galaga, where the player has to shoot and avoid other enemy ships in order to get to the next level
